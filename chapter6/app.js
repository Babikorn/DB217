...
const filtered_data = data.filter(
  ...
  let months = new Set(
    filtered_data.map(d=>d.month_save));
...
let dname = new Set(filtered_data.map(d=>d.dname)
);
dname = [...dname].sort();
...
if(population % 2 == 0) {
  ...
  document.querySelector('#median').innerHTML = mean.toFixed(4);
